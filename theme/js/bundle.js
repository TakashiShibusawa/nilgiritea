...
var _jsonpPromise = __webpack_require__(18);
				...
				return regeneratorRuntime.wrap(function _callee$(_context) {
					while (1) {
						switch (_context.prev = _context.next) {
							...
							case 2:
								_context.next = 4;
								return (0, _jsonpPromise2.default)(uri, { param: 'jsonp' }).promise;

							case 4:
								res = _context.sent;
								return _context.abrupt("return", res.meta.status >= 200 && res.meta.status < 300 ? res : false);
		...
		value: function () {
			var _ref2 = _asyncToGenerator(regeneratorRuntime.mark(function _callee2(_ref3) {
				var type = _ref3.type,
				    ...
				    isIncrement = _ref3$isIncrement === undefined ? false : _ref3$isIncrement,
				    current = _ref3.current,
				    _ref3$page = _ref3.page,
				    page = _ref3$page === undefined ? null : _ref3$page,
				    _ref3$id = _ref3.id,
				    id = _ref3$id === undefined ? null : _ref3$id,
				    hasInfo = _ref3.hasInfo;
				var article;
				return regeneratorRuntime.wrap(function _callee2$(_context2) {
					while (1) {
						switch (_context2.prev = _context2.next) {
							...
							case 4:
								_context2.next = 6;
								return this.fetchContent({ type: type, query: query });

							case 6:
								_context2.t0 = _context2.sent;

							case 7:
								article = _context2.t0;
				...
				return regeneratorRuntime.wrap(function _callee3$(_context3) {
					while (1) {
						switch (_context3.prev = _context3.next) {
							case 0:
								_context3.next = 2;
								return tumblrAPI.fetchAPI(_Constant2.default.getEndPoint({ type: type, query: query }));
							...
							case 5:
								...
								article = this._formatArticle(json.response.posts);
								return _context3.abrupt("return", article || false);
...
var riot = __webpack_require__(0);
riot.tag2('niltea-analytics', '', '', '', function (opts) {});
...
var _class_loader = __webpack_require__(17);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_riot_observable__ = __webpack_require__(19);
...
if(!(TO_PRIMITIVE in proto))__webpack_require__(33)(proto, TO_PRIMITIVE, __webpack_require__(139));
