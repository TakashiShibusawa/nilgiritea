...
riot.tag2('niltea-list-item', '<article each="{item in opts.articlelist}" riot-style="background-image: url({item.photos ? item.photos[0].original_size.url : null});" class="post_item loader_bgi"> <a class="post_item_link" href="/post/{item.id}"> <div class="post_item_info"> <h3 class="post_item_title"><raw content="{item.title}"></raw></h3> <section class="post_item_meta"> <span class="post_item_date">{this.formatDate(item.date)}</span><br><span class="post_item_notes">{item.note_count} notes</span> </section> </div> </a> </article>', 'niltea-list-item .post_item,[data-is="niltea-list-item"] .post_item{ will-change: filter; width: 100%; height: 350px; margin: 15px auto 0; background: #888 center center no-repeat; background-size: cover; } niltea-list-item .post_item:first-child,[data-is="niltea-list-item"] .post_item:first-child{ margin-top: 0; } niltea-list-item .post_item_link,[data-is="niltea-list-item"] .post_item_link{ background-color: rgba(255, 255, 255, 0.4); transition: background-color 0.2s; display: block; width: 100%; height: 100%; box-sizing: border-box; padding: 25px; text-decoration: none; color: #000; } niltea-list-item .post_item_link:hover,[data-is="niltea-list-item"] .post_item_link:hover{ transition: background-color 0.4s; background-color: rgba(255, 255, 255, 0.1); } niltea-list-item .post_item_info,[data-is="niltea-list-item"] .post_item_info{ width: 100%; height: 100%; box-sizing: border-box; border: 4px solid #000; border-radius: 2px; display: flex; align-items: flex-start; flex-direction: column; justify-content: space-between; padding: 10px; } niltea-list-item .post_item_title,[data-is="niltea-list-item"] .post_item_title{ margin-left: -30px; padding: 3px 8px 0; font-size: 2.2em; line-height: 1.5; background-color: #fff; display: inline-block; } niltea-list-item .post_item_meta,[data-is="niltea-list-item"] .post_item_meta{ align-self: flex-end; text-align: right; } niltea-list-item .post_item_date,[data-is="niltea-list-item"] .post_item_date,niltea-list-item .post_item_notes,[data-is="niltea-list-item"] .post_item_notes{ display: inline-block; } niltea-list-item .post_item_date,[data-is="niltea-list-item"] .post_item_date{ margin-top: 5px; padding: 2px 8px; font-size: 1.6em; background-color: #fff; } niltea-list-item .post_item_notes,[data-is="niltea-list-item"] .post_item_notes{ margin-top: 5px; padding: 2px 8px; font-size: 1.0em; background-color: #fff; }', '', function (opts) {
	const self = this;
